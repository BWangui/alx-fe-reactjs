function UserProfile() {
  return (
    <div className="bg-gray-100 sm:p-4 md:p-6 md:p-8 max-w-xs sm:max-w-sm md:max-w-sm lg:max-w-lg xl:max-w-xl mx-auto my-10 sm:my-16 md:my-20 rounded-lg shadow-lg transition-shadow duration-300 ease-in-out hover:shadow-xl">
      <img
